return {
    ...
    vehicles = {
        ...
        categories = {
            ...
            addonvans = 'addonshop',
            addoncompacts = 'addonshop',
            addonsedans = 'addonshop',
    ...
    shops = {
        ...
        pdshop = {
            ...
            zone = {
                shape = {
                    vec3(466.13, -1021.28, 27.09),
                    vec3(451.79, -1022.54, 27.46),
                    vec3(452.0, -1012.11, 27.51),
                    vec3(466.13, -1012.96, 27.08),
                },
                size = vec3(3, 3, 4),
                targetDistance = 1,
            },
            blip = {
                label = 'LEO Dealership',
                coords = vec3(458.08, -1016.68, 28.24),
                show = false,
                sprite = 326,
                color = 3,
            },
            ...
            returnLocation = vec3(460.92, -1014.59, 27.08),
            vehicleSpawns = {
                vec4(455.92, -1015.04, 28.4, 89.6),
            },
            showroomVehicles = {
                { coords = vec4(462.16, -1019.72, 28.12, 91.0), vehicle = 'pdfpiu' },
            },
        },
         ...
         addonshop = {
             ...
             showroomVehicles = {
                 { coords = vec4(-1265.31, -354.44, 35.91, 205.08), vehicle = '19exp' },
                 { coords = vec4(-1270.06, -358.55, 35.91, 247.08), vehicle = 'golf8gti' },
                 { coords = vec4(-1269.21, -365.03, 35.91, 297.12), vehicle = 'impa6' },
                 { coords = vec4(-1252.07, -364.2, 35.91, 56.44), vehicle = 'cmr11' },
                 { coords = vec4(-1255.49, -365.91, 35.91, 55.63), vehicle = 'm422' },
                 { coords = vec4(-1249.21, -362.97, 35.91, 53.24), vehicle = 'f15078' },
             }
         },
