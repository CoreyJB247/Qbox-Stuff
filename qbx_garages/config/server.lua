return {
    ...
    garages = {
        -- Police Stations
        mrpd = {
            label = 'LSPD Station 1',
            vehicleType = VehicleType.CAR,
            groups = 'police',
            accessPoints = {
                {
                    coords = vec4(435.28, -1026.24, 28.84, 357.92),
                    spawn = vec4(435.28, -1026.24, 28.84, 357.92),
                }
            },
        },
        sahp = {
            label = 'SAHP Station 1',
            vehicleType = VehicleType.CAR,
            groups = 'police',
            accessPoints = {
                {
                    coords = vec4(-3155.68, 1157.04, 21.08, 239.8),
                    spawn = vec4(-3155.68, 1157.04, 21.08, 239.8),
                }
            },
        },
