return {
    ...
    money = {
        ...
        ---@type Money
        moneyTypes = { cash = 1000, bank = 5000, crypto = 0 }, -- type = startamount - Add or remove money types for your server (for ex. blackmoney = 0), remember once added it will not be removed from the database!
    ...
    player = {
        ...
        thirstRate = 3.4, -- Rate at which thirst goes down.
    ...
    characters = {
        ...
        defaultNumberOfCharacters = 25, -- Define maximum amount of default characters (maximum 3 characters defined by default)
    },
    ...
    persistence = {
        lockState = 'unlock', -- 'lock' : vehicle will be locked when spawned, 'unlock' : vehicle will be unlocked when spawned
    },
